...
class LoginController: UIViewController {
    ...
    let inputsContainerView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(r: 237, g: 172, b: 31)
    ...
    lazy var loginRegisterButton: UIButton = {
        ...
        button.backgroundColor = UIColor(r: 118, g: 186, b: 67)
    ...
    lazy var cancelButton: UIButton = {
        ...
        cButton.backgroundColor = UIColor(r: 118, g: 186, b: 67)
        ...
        cButton.addTarget(self, action: #selector(handleCancel), for: .touchUpInside)
        return cButton
    }()
    ...
    lazy var profileImageView: UIImageView = {
        ...
        imageView.image = UIImage(named: "wmpologonoback")
    ...
    lazy var loginRegisterSegmentedControl: UISegmentedControl = {
        ...
        sc.tintColor = UIColor(r: 118, g: 186, b: 67)
    ...
    func setupCancelButton() {
        ...
        cancelButton.topAnchor.constraint(equalTo: loginRegisterButton.bottomAnchor, constant: 12).isActive = true
